...
sw_mesa_shader_cache = Path(f'{Path.home()}/.cache/mesa_shader_cache')
sw_mesa_shader_cache_sf = Path(f'{Path.home()}/.cache/mesa_shader_cache_sf')
sw_mesa_shader_cache_db = Path(f'{Path.home()}/.cache/mesa_shader_cache_db')
sw_radv_shader_cache = Path(f'{Path.home()}/.cache/radv_builtin_shaders')
sw_gl_shader_cache = Path(f'{Path.home()}/.cache/gl_shader_cache')
sw_nvgl_shader_cache = Path(f'{Path.home()}/.nv/GLCache')
sw_nvidia_shader_cache = Path(f'{Path.home()}/.cache/nvidia')
